...
use App\Http\Resources\ContestUsers\OpponentUnitsResource;
 ...
 *                 @OA\Items(ref="#/components/schemas/OpponentUnitsResource")
 *             )
 *         )
 *     ),
...
class OpponentUnits extends Controller
{
    public function __invoke(
        ...
        return new OpponentUnitsResource($opponentContestUser);
    }
}
