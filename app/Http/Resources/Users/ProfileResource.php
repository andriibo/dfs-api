 ...
 *     @OA\Property(property="favTeamId", type="integer"),
 *     @OA\Property(property="favPlayerId", type="integer"),
 ...
 *     @OA\Property(property="avatarId", type="integer"),
 *     @OA\Property(property="isEmailConfirmed", type="integer", enum={0,1}),
 *     @OA\Property(property="invitedByUser", type="integer"),
